...
public class Expression_Evaluator {
	...
	public void evaluate() throws Exception
	{
		...
		result = AirthmeticFactory.getFactory(operation).cal(result, checkDigit(element));
	...
	// to check the operand is a value to retrun the value else if scientifc or trignometric operands evaluate and return else handle invalid value
	
	private double checkDigit(String element) throws Exception{
		// TODO Auto-generated method stub
		try {
			Double val= Double.valueOf(element.trim());
