 ...
 * This kind of testing is sometimes called behavior testing. Behavior testing does not check the result of 
 * a method call, but it checks that a method is called with the right parameters.
 * 
 * @author admi
 *
 */
...
public class MockitoVerifyTest {
    ...
    public void testVerify(@Mock Database database)  {
        ...
        /**
         * In case you do not care about the value, 
         * use the anyX, e.g., anyInt, anyString(), or any(YourClass.class) methods.
         */
    }
